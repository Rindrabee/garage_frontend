<template>
  ...
  <div class="cont">
      ...
      <form>
      <div  class="box">
      <h1 class="form-title">Registration MECANICIEN</h1>
        ...
        <div id="pejy1" class="page1">
          ...
          <div class="user-input-box">
            ...
            <div style="color: red;margin-right: 120px;font-size: 14px;" v-if="isFieldEmpty && !Naissance" class="field-message">Veuillez compléter ce champ</div>
          </div>
  
          <div class="user-input-box">
          <label for="specialite">Specialité</label>
          <div class="gender-category">
            <select  v-model="Specialite" class="selecting" name="specialite" id="specialite">
              <option style="font-family: century gothic;" value="Diagnostic des problèmes mécaniques">Diagnostic des problèmes mécaniques</option>
              <option style="font-family: century gothic;" value="Réparation du moteur">Réparation du moteur</option>
              <option style="font-family: century gothic;" value="Entretien régulier">Entretien régulier</option>
              <option style="font-family: century gothic;" value="Systèmes de freinage">Systèmes de freinage</option>
              <option style="font-family: century gothic;" value="Systèmes de suspension et direction">Systèmes de suspension et direction</option>
              <option style="font-family: century gothic;" value="Électricité automobile">Électricité automobile</option>
              <option style="font-family: century gothic;" value="Systèmes de climatisation et de refroidissement">Systèmes de climatisation et de refroidissement</option>
              <option style="font-family: century gothic;" value="Systèmes d'échappement">Systèmes d'échappement</option>
        ...
        <div id="pejy2" class="page2">
          ...
          <div class="user-input-box">
            ...
            <input v-model="langue_parle" type="text" id="language" name="language" :placeholder="isFieldEmpty && !langue_parle ? 'Entrer votre langue parler' : 'Entrer votre langue parler'" :class="{'error': isFieldEmpty && !langue_parle}">
          </div>

          <div class="user-input-box">
            <label for="experience">Experience</label>
            <textarea v-model="Experience" name="experience" id="experience" cols="38" rows="5" :placeholder="isFieldEmpty && !Experience ? 'Lister votre experience' : 'Lister votre experience'" :class="{'error': isFieldEmpty && !Experience}"></textarea>
          </div>

          <div class="user-input-box">
            <label for="certification">Certification</label>
            <textarea v-model="certification" name="certification" id="certification" cols="38" rows="5" :placeholder="isFieldEmpty && !certification ? 'Lister votre certificat' : 'Lister votre certificat'" :class="{'error': isFieldEmpty && !certification}"></textarea>
          </div>
        ...
        <input @click="slide2" type="button" style="position: absolute;  display: block;margin-top: 340px ;font-size: 15px;padding: 10px;border: none;border-radius: 3px;"  value="Precedent" class="precedent">
  
     
        <input @click="slide3" type="button" style="position: absolute; margin-left: 495px; display: block;margin-top: 340px ;font-size: 15px;padding: 10px;border: none;border-radius: 3px;"  value="Suivant" class="precedent">
      </div>
      ...
      <div style="color: #fff;" class="condition">
          ...
          <ul><br>
           <li><strong>Excellence professionnelle :</strong> Notre objectif principal est de vous offrir une expérience professionnelle d'excellence.</li>
           <li><strong>Transparence des transactions :</strong> Nous croyons en une totale transparence dans nos transactions. Avant d'effectuer une réparation ou de fournir un service, nous veillerons à vous informer clairement des coûts associés.</li>
           <li><strong>Engagement envers la satisfaction du client :</strong> La satisfaction de nos clients est notre priorité absolue. Nous nous efforçons de mériter votre confiance et de fournir un service qui répond à vos attentes.</li>
           <li><strong>Support clientèle :</strong> Notre équipe dévouée et professionnelle est là pour vous apporter un soutien de qualité.</li>
          </ul>
          <br>
  ...
  <script>
  import AuthenticationService3 from '../services/AuthentificationService3.js'
  ...
  if (inputDate > dateLimite) {
    alert("Il est illogique d'indiquer une date de naissance postérieure à 18 ans par rapport à la date d'aujourd'hui.");
    return false;
  }
  ...
  return true;
    ...
    const response = await AuthenticationService3.register({
      Nom: this.Nom,
  ...
  createBase64Image(fileObject) {
    ...
    reader.readAsDataURL(fileObject);
        ...
        slide1() {
          if (!this.Nom || !this.Email || !this.Naissance || !this.Prenoms || !this.Specialite || !this.Adresse || !this.Sexe) {
      ...
      if (!isValidDate) {
        ...
        slide3() {
        if (!this.Telephone || !this.langue_parle || !this.Experience || !this.certification || !this.Password) {
        this.isFieldEmpty = true;
        return;
        }
