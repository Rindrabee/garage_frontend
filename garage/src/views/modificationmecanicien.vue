<template>
                ...
                <div class="col-md-10 mt-5 pt-5">
                    <div style="box-shadow: 1px 1px 4px black;width: 1100px;margin-left: -100px;margin-top: -40px;margin-bottom: 40px;"  class="row z-depth-3">
                        <div class="col-sm-4 bg-success rounded-left">
                            ...
                            <i @click="mecanicienpage" style="color: white;cursor: pointer;" class="fas fa-arrow-left"></i>
                        ...
                        <div class="col-sm-8 bg-white rounded-right">
                            ...
                            <div class="col-sm-5">
                                <input @click="mecanicienpage" class="btn btn-outline-success" type="button" value="Annuler">
                                </div>
    
                                <div class="col-sm-5">
                                <input @click="updateMecanicien" class="btn btn-outline-success" type="button" value="Modifier">
                                </div>
                            </div>
    ...
    export default {
      data () {
        ...
        //Rediriger vers le page mecanicien
        mecanicienpage() {
