<template>
    ...
    <div class="cont">
                ...
                <div id="rindra" class="settings-menu">
                    ...
                    <div class="settings-menu-inner">
                        <div class="settings-links">
                            ...
                            <a @click="modificationgarage" style="color: #000;font-family: century gothic;cursor: pointer;">PROFILE<img style="width: 10px;" src="../assets/images/arrow.png" alt=""></a>
                        </div>
            ...
            <div class="sidebar-menu">
                <span @click="garagepage" class="fas fa-home"></span><p @click="garagepage" style="font-size: 13px;">Accueil</p>
            </div>
