<template>
    ...
    <div class="cont">
        ...
        <div   class="profile">
            <img style="cursor: pointer;" class="profile-image" :src="'http://localhost:8082/' +  Client.Photo  + '.jpeg'"  alt="">
        ...
        <div style="margin-top: 10px;" class="container">
         ...
         <p style="font-family: century gothic; margin-left: 90px">Nous vous présentons tous les listes de nos garages partenaires :</p>
        </div>
