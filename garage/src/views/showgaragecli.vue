<template>
                ...
                <div class="col-md-10 mt-5 pt-5">
                    <div style="box-shadow: 1px 1px 4px black;width: 1100px;margin-left: -100px;margin-top: -40px;"  class="row z-depth-3">
                        <div class="col-sm-4 bg-success rounded-left">
                            ...
                            <i @click="garageclient" style="color: white;cursor: pointer;" class="fas fa-arrow-left"></i>
                        ...
                        <div class="col-sm-8 bg-white rounded-right">
                            ...
                            <div class="col-sm-5">
                            <input  v-if="Client.Etat2 == null" @click="reffuserclient" class="btn btn-outline-danger" type="button" value="Reffuser">
                            </div>

                            <div class="col-sm-5">
                            <input v-if="Client.Etat2 == null" @click="accepterclient" class="btn btn-outline-success" type="button" value="Accepter">
                            </div>

                            <div class="col-sm-5">
                            <input v-if="Client.Etat2 == 1" style="margin-left: 100px;" @click="bloquerclient" class="btn btn-outline-danger" type="button" value="Bloquer">
                            </div>
    ...
    export default {
      data () {
        ...
        //Rediriger vers le garageclient
        garageclient() {
        ...
        // Accepter le demande du client
        accepterclient() {
        axios
        .put('http://localhost:8082/api/garages/acceptcli/' +  localStorage.getItem('id'))
        .then(response => {
        alert('Vous avez accepter un nouveau client !!');
        ...
        // Reffuser le demande du client
        reffuserclient() {
        axios
        .put('http://localhost:8082/api/garages/reffusercli/' +  localStorage.getItem('id'))
        .then(response => {
        alert('Client reffuser !!');
        console.log(response.data);
        })
        .catch(error => {
        console.log(error);
        ...
        bloquerclient() {
        axios
        .put('http://localhost:8082/api/garages/bloquerclient/' +  localStorage.getItem('id'))
        .then(response => {
