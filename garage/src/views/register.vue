    ...
    <h1 class="form-title">Registration</h1>
      ...
      <div id="pejy1" class="page1">
        ...
        <div class="user-input-box">
          ...
          <input v-model="Profession" type="text" id="profession" name="profession" placeholder="Entrer votre profession">
        </div>
      ...
      <input @click="slide2" style="position: absolute;  display: block;margin-top: 140px;font-size: 15px;padding: 10px;border: none;border-radius: 3px;" type="submit" value="Precedent" class="precedent">
